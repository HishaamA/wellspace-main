...
def plot_frequency_graph(data, filename):
    ...
    plt.title('Frequency of Severity of Student Issues')
...
def json_strip(msg):
    ...
    msg = msg[st:ed+1]
    return msg
def send_mail(session_id):
    sender_addr = "noreply@wellspace.ampiere.co"
    api_key = "6231a090ddf9941ce92b96f7a59d02c9-7a3af442-ffc4c642"
    sender_name = "WellSpace"
    auth = ('api', api_key)
    session_id = str(session_id)
    base_url = "https://api.eu.mailgun.net/v3/wellspace.ampiere.co/messages"
    with open('userdata.json', 'r') as f:
        data = json.load(f)
    data = data[session_id]
    print(data)
    text_content = data['issue']['content'] + (f'\n\nStudent: {data["person"]["name"]}\nClass: {data["person"]["grade"]} {data["person"]["section"]}')
    severity = data['issue']['severity']
    title = f"WellSpace Student Complaint: {data['issue']['problem']}"
    recv_addr = "neatpolls@gmail.com"
...
<style>
		* {
		...
		@media (max-width:780px) {
			...
			.row-5 .column-1 .block-5.spacer_block {
...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ffffff; color: #000000; width: 760px; margin: 0 auto;" width="760">
<tbody>
<tr>
...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f6f5f1; border-radius: 0; color: #000000; width: 760px; margin: 0 auto;" width="760">
<tbody>
<tr>
<td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
<table border="0" cellpadding="0" cellspacing="0" class="empty_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f6f5f1; border-radius: 0; color: #000000; background-image: url('images/BEE_May20_MarketingAgency_DashboardMetrics_v02.jpg'); background-repeat: no-repeat; background-size: cover; width: 760px; margin: 0 auto;" width="760">
<tbody>
<tr>
...
<div style="max-width: 760px;"><img height="auto" src="https://s6.imgcdn.dev/q7Nd2.png" style="display: block; height: auto; border: 0; width: 100%;" width="760"/></div>
</div>
</td>
</tr>
</table>
...
<tr>
<td class="pad">
<h1 style="margin: 0; color: #177686; direction: ltr; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 38px; font-weight: 600; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 45.6px;"><span class="tinyMce-placeholder" style="word-break: break-word;">Student Name</span></h1>
</td>
</tr>
</table>
</td>
...
<div style="color:#222222;direction:ltr;font-family:'Poppins', Arial, Helvetica, sans-serif;font-size:27px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:32.4px;">
<p style="margin: 0;">"""+f"""{data["person"]["name"]}</p>
</div>
</td>
</tr>
</table>
...
<tr>
<td class="pad">
<h1 style="margin: 0; color: #177686; direction: ltr; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 38px; font-weight: 600; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 45.6px;"><span class="tinyMce-placeholder" style="word-break: break-word;">Class</span></h1>
</td>
</tr>
</table>
...
<td class="pad" style="padding-top:10px;">
<div style="color:#222222;direction:ltr;font-family:'Poppins', Arial, Helvetica, sans-serif;font-size:27px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:32.4px;">
<p style="margin: 0;">{str(data['person']['grade'])+data['person']['section']}</p>
</div>
</td>
</tr>
</table>
...
<tbody>
<tr>
<td class="column column-1" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; background-color: #ffffff; padding-bottom: 25px; padding-left: 20px; padding-right: 20px; padding-top: 30px; vertical-align: middle; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
<table border="0" cellpadding="0" cellspacing="0" class="heading_block block-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
<tr>
<td class="pad" style="padding-left:10px;padding-right:10px;text-align:center;width:100%;">
<h2 style="margin: 0; color: #177686; direction: ltr; font-family: 'Poppins', Arial, Helvetica, sans-serif; font-size: 22px; font-weight: 600; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 26.4px;"><span class="tinyMce-placeholder" style="word-break: break-word;">Student Report</span></h2>
</td>
</tr>
</table>
...
<tr>
<td class="pad">
<div style="color:#444a5b;direction:ltr;font-family:'Poppins', Arial, Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
<p style="margin: 0;">{data['issue']['content']}</p>
</div>
</td>
</tr>
</table>
...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #177686; color: #000000; width: 760px; margin: 0 auto;" width="760">
<tbody>
<tr>
...
<tr>
<td class="pad">
<div style="color:#ffffff;direction:ltr;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:28px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:center;mso-line-height-alt:33.6px;">
<p style="margin: 0;">wellspace.ampiere.co</p>
</div>
</td>
</tr>
</table>
...
<tr>
    ...
    response = requests.post(base_url, data=email, auth=auth)
