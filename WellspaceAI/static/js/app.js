...
async function get_response(query) {
    let response = await fetch('/'+session_id+'/message', {
        headers: {
...
ask_btn.addEventListener("click", async () => {
    ...
    gemini_avatar_div.innerHTML = `<img class="avatar" src="static/flower.png"/> <span id="chicken">WellSpace Assistant</span>`
